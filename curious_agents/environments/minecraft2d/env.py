...
from curious_agents.environments.minecraft2d.constants import MOVES
...
from curious_agents.environments.minecraft2d.viewer import MazeEnvViewer
...
class Minecraft2D(Environment[State]):
    ...
    def __init__(
        ...
        self._viewer = viewer or MazeEnvViewer("Minecraft2D", render_mode="human")
